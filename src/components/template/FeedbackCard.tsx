...
const FeedbackCard = (props:IFeedBackCardProps)  => {
  ...
  return (
    <li className="w-full max-h-1/5 rounded-xl p-3 mb-5 dark:shadow-[5px_5px_15px_#141414,-5px_-5px_15px_#323232] shadow-[5px_5px_15px_#5a5a5a,-5px_-5px_15px_#ffffff]">
