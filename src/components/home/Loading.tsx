...
export const Loading = ({ phrases }: ILoadingProps) => {
  ...
  return (
    <div className="w-screen h-screen bg-zinc-800 flex items-center justify-center">
      <div className="w-[60%] h-[40%] bg-zinc-700 rounded-xl flex flex-col items-center justify-center">
        <h1 className="font-bold mb-12 text-2xl">{phrases[currentPhraseIndex]}</h1>
