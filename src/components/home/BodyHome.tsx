function BodyHome() {
    return ( 
        <body className=" w-full h-full ">
                    <div className="flex md:flex-row flex-col w-full h-[90%] dark:bg-[#232323] bg-[#E0E5EC] dark:text-white text-black">
                        <div className="flex flex-col items-center w-full md:w-[40%] md:pb-[174px]">
                            <h1 className="md:w-[80%] w-full text-5xl font-bold ">Conheça o Financial Controller!</h1>
                            <p className="text-md md:w-[80%] w-full h-fit mt-5 ">
                        ...
                        <div className="w-full h-[40rem] md:w-[60%] flex items-center justify-center">
                            <div className="dark:shadow-[inset_10px_10px_19px_#121212,inset_-10px_-10px_19px_#343434] shadow-[inset_10px_10px_19px_#727578,inset_-10px_-10px_19px_#FFFFFF] rounded-[5rem] w-[90%] md:w-[80%] h-[80%] flex items-center justify-center">
