...
function CabecalhoHome() {
    ...
    return ( 
        <div className={`dark:bg-[#232323] bg-[#E0E5EC] w-full h-[10vh] transition-all duration-500 ease-linear lg:mb-5`}>
                <header className="flex items-center w-full h-[10vh]">
                    <div className="flex flex-row items-center justify-start h-full w-full">
                        <div className="ml-[4rem] w-[30%] hidden lg:flex">
                            <Image src={tema  === "" ? (logoBlack) : (logoWhite)} alt="" width="500" height="65" className=""></Image> 
                        </div>
                        <div className="ml-3 mt-8 lg:hidden">
                        <Image src={tema  === "" ? (iconBlack) : (iconWhite)} alt="" width="150" height="100" className=""></Image>
                        </div>
                        <div className="flex flex-row w-full mt-8 justify-end items-center">
                            ...
                            textClassName="transition-all duration-500 ease-linear text-transparent bg-clip-text bg-gradient-to-r from-[#0085FF] to-[#1400FF] dark:bg-gradient-to-r dark:from-[#00F0FF] dark:to-[#00A5BC]"></ButtonDark>
                        </div>
                    </div>
                </header>
            </div>
